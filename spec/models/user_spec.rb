...
describe User do
  ...
  it "should create a new instance given valid attributes" do
	...
	it "should require an meail address" do
	...
	it "should reject duplicate names" do
		User.create!(@attr)
		user_with_duplicate_name = User.new(@attr.merge(:email => "foo@bar.com"))
		user_with_duplicate_name.should_not be_valid
	end

	it "should reject duplicate email addresses" do
		User.create!(@attr)
		user_with_duplicate_email = User.new(@attr.merge(:name => "Foo Bar"))
		user_with_duplicate_email.should_not be_valid
	end

	it "should reject email addresses identical up to case" do
		upcased_email = @attr[:email].upcase
		User.create!(@attr.merge(:email => upcased_email, :name => "Foo Bar"))
	...
	it "should reject email addresses identical up to case" do
	 ...
	 User.create!(@attr.merge(:name => upcased_name, :email => "foo@bar.com"))
	 user_with_duplicated_name = User.new(@attr)
	 user_with_duplicated_name.should_not be_valid
	end
	...
	describe "remember me" do
		...
		it "should have a rember_me! method" do
